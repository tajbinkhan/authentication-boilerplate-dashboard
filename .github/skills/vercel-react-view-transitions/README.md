...
- **`<ViewTransition>` component** — animation triggers (enter, exit, update, share), placement
  rules, View Transition Classes
...
- **Next.js integration** — `experimental.viewTransition`, the `transitionTypes` prop on
  `next/link`, App Router patterns
...
- [Next.js App Router Playground (view transitions)](https://github.com/vercel/next-app-router-playground/tree/main/app/view-transitions)
  — Vercel's reference implementation
